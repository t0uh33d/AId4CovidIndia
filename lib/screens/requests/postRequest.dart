...
import 'package:oxygenforcovid/screens/requests/locationSearchRequest.dart';
...
class _PostRequestState extends State<PostRequest> {
  ...
  Widget build(BuildContext context) {
    ...
    var postController = Get.put(RequestController());
    return loading
        ? Loader()
        : Scaffold(
            backgroundColor: CustomColors().backgroundColor,
            appBar: CustomWidgets().centerTitleAppBar(title: 'Add a Request'),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomWidgets().formLabel(
                              label: 'Any relevant information (optional)'),
                          SizedBox(height: 5.0),
                          TextFormField(
                            maxLines: 5,
                            decoration: otpinputDecoration,
